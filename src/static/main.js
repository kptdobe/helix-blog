...
var AppComponent = /** @class */ (function () {
    function AppComponent(contentService) {
        ...
        this.content = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
    }
    AppComponent.prototype.loadContent = function () {
        ...
        this.contentService.getContent('/README')
            ...
            _this.content.next(json);
        });
    };
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.content.asObservable().subscribe(function (json) {
            console.log('in content subscribe: ', json);
            _this.title = json.resource.title;
            _this.intro = json.resource.intro;
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(10000).subscribe(function () { return _this.loadContent(); });
        this.loadContent();
    };
...
var ContentService = /** @class */ (function () {
    ...
    ContentService.prototype.getContent = function (path) {
